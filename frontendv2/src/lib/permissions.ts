...
class Permissions {
    ...
    public static getAll(): Array<{ constant: string; value: string; category: string; description: string }> {
        return [
            ...
            { constant: 'ADMIN_LOCATIONS_VIEW', value: Permissions.ADMIN_LOCATIONS_VIEW, category: 'Admin Locations', description: 'View locations' },
            ...
            { constant: 'ADMIN_REALMS_VIEW', value: Permissions.ADMIN_REALMS_VIEW, category: 'Admin Realms', description: 'View realms' },
            { constant: 'ADMIN_REALMS_CREATE', value: Permissions.ADMIN_REALMS_CREATE, category: 'Admin Realms', description: 'Create new realms' },
            { constant: 'ADMIN_REALMS_EDIT', value: Permissions.ADMIN_REALMS_EDIT, category: 'Admin Realms', description: 'Edit existing realms' },
            { constant: 'ADMIN_REALMS_DELETE', value: Permissions.ADMIN_REALMS_DELETE, category: 'Admin Realms', description: 'Delete realms' },
            { constant: 'ADMIN_SPELLS_VIEW', value: Permissions.ADMIN_SPELLS_VIEW, category: 'Admin Spells', description: 'View spells' },
            { constant: 'ADMIN_SPELLS_CREATE', value: Permissions.ADMIN_SPELLS_CREATE, category: 'Admin Spells', description: 'Create new spells' },
            { constant: 'ADMIN_SPELLS_EDIT', value: Permissions.ADMIN_SPELLS_EDIT, category: 'Admin Spells', description: 'Edit existing spells' },
            { constant: 'ADMIN_SPELLS_DELETE', value: Permissions.ADMIN_SPELLS_DELETE, category: 'Admin Spells', description: 'Delete spells' },
            { constant: 'ADMIN_NODES_VIEW', value: Permissions.ADMIN_NODES_VIEW, category: 'Admin Nodes', description: 'View nodes' },
            { constant: 'ADMIN_NODES_CREATE', value: Permissions.ADMIN_NODES_CREATE, category: 'Admin Nodes', description: 'Create new nodes' },
            { constant: 'ADMIN_NODES_EDIT', value: Permissions.ADMIN_NODES_EDIT, category: 'Admin Nodes', description: 'Edit existing nodes' },
            { constant: 'ADMIN_NODES_DELETE', value: Permissions.ADMIN_NODES_DELETE, category: 'Admin Nodes', description: 'Delete nodes' },
            { constant: 'ADMIN_ROLES_VIEW', value: Permissions.ADMIN_ROLES_VIEW, category: 'Admin Roles', description: 'View roles' },
            ...
            { constant: 'ADMIN_DATABASES_VIEW', value: Permissions.ADMIN_DATABASES_VIEW, category: 'Admin Databases', description: 'View databases' },
            { constant: 'ADMIN_DATABASES_CREATE', value: Permissions.ADMIN_DATABASES_CREATE, category: 'Admin Databases', description: 'Create new databases' },
            { constant: 'ADMIN_DATABASES_EDIT', value: Permissions.ADMIN_DATABASES_EDIT, category: 'Admin Databases', description: 'Edit existing databases' },
            { constant: 'ADMIN_DATABASES_DELETE', value: Permissions.ADMIN_DATABASES_DELETE, category: 'Admin Databases', description: 'Delete databases' },
            { constant: 'ADMIN_ROLES_PERMISSIONS_VIEW', value: Permissions.ADMIN_ROLES_PERMISSIONS_VIEW, category: 'Admin Role Permissions', description: 'View role permissions' },
            { constant: 'ADMIN_ROLES_PERMISSIONS_CREATE', value: Permissions.ADMIN_ROLES_PERMISSIONS_CREATE, category: 'Admin Role Permissions', description: 'Create new role permissions' },
            { constant: 'ADMIN_ROLES_PERMISSIONS_EDIT', value: Permissions.ADMIN_ROLES_PERMISSIONS_EDIT, category: 'Admin Role Permissions', description: 'Edit existing role permissions' },
            { constant: 'ADMIN_ROLES_PERMISSIONS_DELETE', value: Permissions.ADMIN_ROLES_PERMISSIONS_DELETE, category: 'Admin Role Permissions', description: 'Delete role permissions' },
            { constant: 'ADMIN_SETTINGS_VIEW', value: Permissions.ADMIN_SETTINGS_VIEW, category: 'Admin Settings', description: 'View settings' },
            { constant: 'ADMIN_SETTINGS_EDIT', value: Permissions.ADMIN_SETTINGS_EDIT, category: 'Admin Settings', description: 'Edit and manage settings' },
            { constant: 'ADMIN_STORAGE_SENSE_VIEW', value: Permissions.ADMIN_STORAGE_SENSE_VIEW, category: 'Admin Storage Sense', description: 'View Storage Sense insights and cleanup candidates' },
            { constant: 'ADMIN_STORAGE_SENSE_MANAGE', value: Permissions.ADMIN_STORAGE_SENSE_MANAGE, category: 'Admin Storage Sense', description: 'Run Storage Sense cleanup actions' },
            { constant: 'ADMIN_ALLOCATIONS_VIEW', value: Permissions.ADMIN_ALLOCATIONS_VIEW, category: 'Admin Allocations', description: 'View allocations' },
            { constant: 'ADMIN_ALLOCATIONS_CREATE', value: Permissions.ADMIN_ALLOCATIONS_CREATE, category: 'Admin Allocations', description: 'Create new allocations' },
            { constant: 'ADMIN_ALLOCATIONS_EDIT', value: Permissions.ADMIN_ALLOCATIONS_EDIT, category: 'Admin Allocations', description: 'Edit existing allocations' },
            { constant: 'ADMIN_ALLOCATIONS_DELETE', value: Permissions.ADMIN_ALLOCATIONS_DELETE, category: 'Admin Allocations', description: 'Delete allocations' },
            { constant: 'ADMIN_SERVERS_VIEW', value: Permissions.ADMIN_SERVERS_VIEW, category: 'Admin Servers', description: 'View all servers' },
            ...
            { constant: 'ADMIN_SERVERS_INSTALL', value: Permissions.ADMIN_SERVERS_INSTALL, category: 'Admin Servers', description: 'Install servers' },
            ...
            { constant: 'ADMIN_DATABASES_MANAGE', value: Permissions.ADMIN_DATABASES_MANAGE, category: 'Admin Databases', description: 'Manage database' },
            { constant: 'ADMIN_STATISTICS_VIEW', value: Permissions.ADMIN_STATISTICS_VIEW, category: 'Admin Statistics', description: 'View statistics' },
            { constant: 'ADMIN_SUBDOMAINS_VIEW', value: Permissions.ADMIN_SUBDOMAINS_VIEW, category: 'Admin Subdomains', description: 'View subdomains' },
            ...
            { constant: 'ADMIN_FEATHERZEROTRUST_MANAGE', value: Permissions.ADMIN_FEATHERZEROTRUST_MANAGE, category: 'Admin FeatherZeroTrust', description: 'Manage FeatherZeroTrust' },
            { constant: 'ADMIN_NOTIFICATIONS_VIEW', value: Permissions.ADMIN_NOTIFICATIONS_VIEW, category: 'Admin Notifications', description: 'View notifications' },
            ...
            { constant: 'ADMIN_VM_INSTANCES_VIEW', value: Permissions.ADMIN_VM_INSTANCES_VIEW, category: 'Admin VM Instances', description: 'View VM instances' },
            { constant: 'ADMIN_VM_INSTANCES_EDIT', value: Permissions.ADMIN_VM_INSTANCES_EDIT, category: 'Admin VM Instances', description: 'Edit existing VM instances' },
            { constant: 'ADMIN_VM_INSTANCES_DELETE', value: Permissions.ADMIN_VM_INSTANCES_DELETE, category: 'Admin VM Instances', description: 'Delete VM instances' },
            { constant: 'ADMIN_WEBPLATES_VIEW', value: Permissions.ADMIN_WEBPLATES_VIEW, category: 'Admin WebPlates', description: 'View webplates' },
            { constant: 'ADMIN_WEBPLATES_CREATE', value: Permissions.ADMIN_WEBPLATES_CREATE, category: 'Admin WebPlates', description: 'Create new webplates' },
            { constant: 'ADMIN_WEBPLATES_EDIT', value: Permissions.ADMIN_WEBPLATES_EDIT, category: 'Admin WebPlates', description: 'Edit existing webplates' },
            { constant: 'ADMIN_WEBPLATES_DELETE', value: Permissions.ADMIN_WEBPLATES_DELETE, category: 'Admin WebPlates', description: 'Delete webplates' },
            { constant: 'ADMIN_WEBSPACES_VIEW', value: Permissions.ADMIN_WEBSPACES_VIEW, category: 'Admin WebSpaces', description: 'View webspaces' },
            { constant: 'ADMIN_WEBSPACES_CREATE', value: Permissions.ADMIN_WEBSPACES_CREATE, category: 'Admin WebSpaces', description: 'Create new webspaces' },
            { constant: 'ADMIN_WEBSPACES_EDIT', value: Permissions.ADMIN_WEBSPACES_EDIT, category: 'Admin WebSpaces', description: 'Edit existing webspaces' },
            { constant: 'ADMIN_WEBSPACES_DELETE', value: Permissions.ADMIN_WEBSPACES_DELETE, category: 'Admin WebSpaces', description: 'Delete webspaces' },
        ];
    }
}
