...
if (PermissionHelper::hasPermission($userUuid, 'admin.ticket_priorities.create')) {
    // User has permission
}`}
                                </code>
                            </pre>
...
if (PermissionHelper::hasPermission($userUuid, Permissions::ADMIN_TICKET_PRIORITIES_CREATE)) {
    // User has permission
}`}
                                </code>
                            </pre>
