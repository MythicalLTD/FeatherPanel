...
if (PermissionHelper::hasPermission($userUuid, 'admin.servers.create')) {
    // User has permission
}`}
                                </code>
                            </pre>
...
if (PermissionHelper::hasPermission($userUuid, Permissions::ADMIN_SERVERS_CREATE)) {
    // User has permission
}`}
                                </code>
                            </pre>
