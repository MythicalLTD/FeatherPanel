    ...
    permissions: [
        {
            ...
            node: 'admin.users.create',
            category: 'Admin Users',
            description: 'Create new users',
        },
        {
            constant: 'ADMIN_USERS_DELETE',
            node: 'admin.users.delete',
            category: 'Admin Users',
            description: 'Delete users',
        },
        {
            constant: 'ADMIN_USERS_EDIT',
            node: 'admin.users.edit',
            category: 'Admin Users',
...
if (PermissionHelper::hasPermission($userUuid, 'admin.users.create')) {
    // User has permission
}`}
                                </code>
                            </pre>
...
if (PermissionHelper::hasPermission($userUuid, Permissions::ADMIN_USERS_CREATE)) {
    // User has permission
}`}
                                </code>
                            </pre>
