    ...
    events: [
        {
            ...
            name: 'featherpanel:user:server:allocation:deleted',
            callback: 'string server uuid, int allocation id.',
            category: 'ServerAllocation',
            ...
            exampleCode:
                'use App\\Plugins\\PluginEvents;\nuse App\\Plugins\\Events\\Events\\ServerAllocationEvent;\n\npublic static function processEvents(PluginEvents $evt): void\n{\n    $evt->on(ServerAllocationEvent::onServerAllocationDeleted(), function ($allocationId, $serverUuid, $userUuid) {\n        // Handle featherpanel:user:server:allocation:deleted\n        // Data keys: allocation_id, server_uuid, user_uuid\n    });\n}',
        },
        {
            method: 'onServerAllocationError',
            name: 'featherpanel:user:server:allocation:error',
            callback: 'string error message, array context.',
            category: 'ServerAllocation',
            exampleCode:
                'use App\\Plugins\\PluginEvents;\nuse App\\Plugins\\Events\\Events\\ServerAllocationEvent;\n\npublic static function processEvents(PluginEvents $evt): void\n{\n    $evt->on(ServerAllocationEvent::onServerAllocationError(), function ($message, $context) {\n        // Handle featherpanel:user:server:allocation:error\n        // Parameters: string error message, array context.\n    });\n}',
        },
        {
            method: 'onServerAllocationSetPrimary',
            name: 'featherpanel:user:server:allocation:set_primary',
            callback: 'string server uuid, int allocation id, bool is_primary.',
            category: 'ServerAllocation',
            actualData: ['allocation_id', 'server_uuid', 'user_uuid'],
            sourceFiles: ['backend/app/Controllers/User/Server/ServerAllocationController.php'],
            exampleCode:
                'use App\\Plugins\\PluginEvents;\nuse App\\Plugins\\Events\\Events\\ServerAllocationEvent;\n\npublic static function processEvents(PluginEvents $evt): void\n{\n    $evt->on(ServerAllocationEvent::onServerAllocationSetPrimary(), function ($allocationId, $serverUuid, $userUuid) {\n        // Handle featherpanel:user:server:allocation:set_primary\n        // Data keys: allocation_id, server_uuid, user_uuid\n    });\n}',
        },
    ],
};
