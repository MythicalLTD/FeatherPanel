    ...
    events: [
        {
            ...
            actualData: ['article', 'created_by'],
            sourceFiles: ['backend/app/Controllers/Admin/KnowledgebaseController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Knowledgebase',
            actualData: ['article', 'attachment', 'deleted_by'],
            sourceFiles: ['backend/app/Controllers/Admin/KnowledgebaseController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Knowledgebase',
            actualData: ['article', 'attachments'],
            sourceFiles: ['backend/app/Controllers/Admin/KnowledgebaseController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Knowledgebase',
            actualData: ['article', 'attachment', 'uploaded_by'],
            sourceFiles: ['backend/app/Controllers/Admin/KnowledgebaseController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Knowledgebase',
            actualData: ['category', 'created_by'],
            sourceFiles: ['backend/app/Controllers/Admin/KnowledgebaseController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Knowledgebase',
            actualData: ['category', 'deleted_by'],
            sourceFiles: ['backend/app/Controllers/Admin/KnowledgebaseController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Knowledgebase',
            actualData: ['category', 'updated_by'],
            sourceFiles: ['backend/app/Controllers/Admin/KnowledgebaseController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Knowledgebase',
            actualData: ['filename', 'uploaded_by', 'url'],
            sourceFiles: ['backend/app/Controllers/Admin/KnowledgebaseController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Knowledgebase',
            actualData: ['article', 'created_by', 'tag'],
            sourceFiles: ['backend/app/Controllers/Admin/KnowledgebaseController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Knowledgebase',
            actualData: ['article', 'deleted_by', 'tag'],
            sourceFiles: ['backend/app/Controllers/Admin/KnowledgebaseController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Knowledgebase',
            actualData: ['article', 'attachments', 'tags', 'user'],
            sourceFiles: ['backend/app/Controllers/User/KnowledgebaseController.php'],
            exampleCode:
