    ...
    events: [
        {
            ...
            category: 'Subdomains',
            actualData: ['server_data', 'subdomain_data', 'subdomain_uuid', 'user'],
            sourceFiles: ['backend/app/Controllers/User/Server/SubdomainController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Subdomains',
            actualData: ['created_by', 'domain_data'],
            sourceFiles: ['backend/app/Controllers/Admin/SubdomainsController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Subdomains',
            actualData: ['deleted_by', 'domain_data', 'domain_uuid'],
            sourceFiles: ['backend/app/Controllers/Admin/SubdomainsController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Subdomains',
            actualData: ['domain_uuid', 'error_message'],
            sourceFiles: ['backend/app/Controllers/Admin/SubdomainsController.php'],
            exampleCode:
        ...
        },
        {
            ...
            callback: 'string domain uuid, array domain data.',
            category: 'Subdomains',
            actualData: ['domain_data', 'domain_uuid'],
            sourceFiles: ['backend/app/Controllers/Admin/SubdomainsController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Subdomains',
            actualData: ['domains', 'filters', 'includeInactive', 'limit', 'page', 'pagination', 'search', 'total'],
            sourceFiles: ['backend/app/Controllers/Admin/SubdomainsController.php'],
            exampleCode:
        ...
        },
        {
            ...
            category: 'Subdomains',
            actualData: ['domain_uuid', 'new_data', 'old_data', 'updated_by'],
            sourceFiles: ['backend/app/Controllers/Admin/SubdomainsController.php'],
            exampleCode:
