    ...
    events: [
        {
            ...
            name: 'featherpanel:user:server:subuser:created',
            callback: 'string server uuid, array subuser data.',
            category: 'ServerSubuser',
            actualData: ['server_uuid', 'subuser_id', 'user_uuid'],
            sourceFiles: ['backend/app/Controllers/User/Server/SubuserController.php'],
            exampleCode:
                'use App\\Plugins\\PluginEvents;\nuse App\\Plugins\\Events\\Events\\ServerSubuserEvent;\n\npublic static function processEvents(PluginEvents $evt): void\n{\n    $evt->on(ServerSubuserEvent::onServerSubuserCreated(), function ($serverUuid, $subuserId, $userUuid) {\n        // Handle featherpanel:user:server:subuser:created\n        // Data keys: server_uuid, subuser_id, user_uuid\n    });\n}',
        },
        {
            method: 'onServerSubuserDeleted',
            name: 'featherpanel:user:server:subuser:deleted',
            callback: 'string server uuid, int subuser id.',
            category: 'ServerSubuser',
            actualData: ['server_uuid', 'subuser_id', 'user_uuid'],
            sourceFiles: ['backend/app/Controllers/User/Server/SubuserController.php'],
            exampleCode:
                'use App\\Plugins\\PluginEvents;\nuse App\\Plugins\\Events\\Events\\ServerSubuserEvent;\n\npublic static function processEvents(PluginEvents $evt): void\n{\n    $evt->on(ServerSubuserEvent::onServerSubuserDeleted(), function ($serverUuid, $subuserId, $userUuid) {\n        // Handle featherpanel:user:server:subuser:deleted\n        // Data keys: server_uuid, subuser_id, user_uuid\n    });\n}',
        },
        {
            method: 'onServerSubuserError',
            name: 'featherpanel:user:server:subuser:error',
            callback: 'string error message, array context.',
            category: 'ServerSubuser',
            exampleCode:
                'use App\\Plugins\\PluginEvents;\nuse App\\Plugins\\Events\\Events\\ServerSubuserEvent;\n\npublic static function processEvents(PluginEvents $evt): void\n{\n    $evt->on(ServerSubuserEvent::onServerSubuserError(), function ($message, $context) {\n        // Handle featherpanel:user:server:subuser:error\n        // Parameters: string error message, array context.\n    });\n}',
        },
        {
            method: 'onServerSubuserUpdated',
            name: 'featherpanel:user:server:subuser:updated',
            callback: 'string server uuid, int subuser id, array updated data.',
            category: 'ServerSubuser',
            actualData: ['server_uuid', 'subuser_id', 'user_uuid'],
            sourceFiles: ['backend/app/Controllers/User/Server/SubuserController.php'],
            exampleCode:
                'use App\\Plugins\\PluginEvents;\nuse App\\Plugins\\Events\\Events\\ServerSubuserEvent;\n\npublic static function processEvents(PluginEvents $evt): void\n{\n    $evt->on(ServerSubuserEvent::onServerSubuserUpdated(), function ($serverUuid, $subuserId, $userUuid) {\n        // Handle featherpanel:user:server:subuser:updated\n        // Data keys: server_uuid, subuser_id, user_uuid\n    });\n}',
        },
    ],
};
