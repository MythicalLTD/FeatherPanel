            ...
            <div className='space-y-6'>
                ...
                {editing && (
                    <PageCard
                        title={
                            editing.uuid
                                ? t('admin.oidcProviders.editProvider')
                                : t('admin.oidcProviders.createProvider')
                        }
                        icon={Shield}
                    >
                        <div className='space-y-4'>
                            ...
                            <div className='space-y-2'>
                                ...
                                <Input
                                    ...
                                    placeholder={
                                        editing.uuid ? t('admin.oidcProviders.form.clientSecretPlaceholder') : ''
                                    }
                                    className='mt-0'
                                />
                            </div>
                                ...
                                <div className='flex items-center justify-between gap-4'>
                                    ...
                                    <Switch
                                        ...
                                        onCheckedChange={(checked) =>
                                            setEditing({
                                                ...editing,
                                                require_email_verified: checked ? 'true' : 'false',
                                            })
                                        }
                                    />
                                </div>
