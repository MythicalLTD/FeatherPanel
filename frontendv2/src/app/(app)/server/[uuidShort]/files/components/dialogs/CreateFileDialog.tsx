            ...
            <DialogContent className='sm:max-w-xl'>
                ...
                <form onSubmit={handleSubmit} className='space-y-4'>
                    ...
                    <div className='space-y-2'>
                        ...
                        <Textarea
                            className='border-input placeholder:text-muted-foreground focus-visible:ring-ring flex min-h-[150px] w-full rounded-md border px-3 py-2 text-sm shadow-sm focus-visible:ring-1 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50'
