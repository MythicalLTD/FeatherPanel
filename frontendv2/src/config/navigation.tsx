...
export const getAdminNavigationItems = (
    ...
    const items: NavigationItem[] = [
        ...
        },
        {
            ...
            name: t('navigation.items.announcements'),
            title: t('navigation.items.announcements'),
        ...
        },
        {
            ...
            children: [
                ...
                {
                    id: 'admin-blocked-email-domains',
                    name: t('navigation.items.blockedEmailDomains'),
                    title: t('navigation.items.blockedEmailDomains'),
                    url: '/admin/blocked-email-domains',
                    icon: Ban,
                    isActive: false,
                    category: 'admin',
                    permission: Permissions.ADMIN_SETTINGS_VIEW,
