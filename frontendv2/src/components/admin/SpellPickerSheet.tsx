...
export function SpellPickerSheet({
    ...
    return (
        <PickerSheet
            ...
            description={pickerMode === 'browse' ? undefined : t('admin.servers.form.spell_picker_cloud_description')}
            search={spellSearch}
            onSearchChange={setSpellSearch}
            pagination={pickerMode === 'browse' ? pagination : null}
            onPageChange={(page) => setSpellPagination((p) => ({ ...p, current_page: page }))}
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className='flex items-center gap-2 px-4 pb-4'>
                                            ...
                                            <Button size='sm' variant='outline' asChild title='Reviews on marketplace'>
                                                <Link
