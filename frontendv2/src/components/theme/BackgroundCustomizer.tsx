...
export default function BackgroundCustomizer({ children, open, onOpenChange }: BackgroundCustomizerProps) {
    ...
    return (
        <>
            {!isControlled &&
                (children ? (
                    <button type='button' onClick={() => setDialogOpen(true)} className='contents cursor-pointer'>
                        {children}
                    </button>
                ) : (
                    <button
            ...
            >
                ...
                <TabGroup defaultIndex={backgroundType === 'aurora' ? 0 : backgroundType === 'gradient' ? 1 : 2}>
                        ...
                        <TabPanel>
                            ...
                            >
                                ...
                                <div className='text-left'>
                                    <p className='text-sm font-medium'>{t('appearance.background.themeGradient')}</p>
                            ...
                            <div className='space-y-4'>
                                <div className='grid grid-cols-3 gap-3'>
                                    ...
                                    >
                                        ...
                                        <p className='text-xs font-medium'>{t('appearance.background.solidColor')}</p>
                                    </button>
                                    <button
                                        onClick={() => {
                                    ...
                                    >
                                        ...
                                        />
                                        <p className='text-xs font-medium'>{t('appearance.background.dotPattern')}</p>
                                    </button>
                                    <button
                                    ...
                                    >
                                        ...
                                        <p className='text-xs font-medium'>{t('appearance.background.customImage')}</p>
                                    </button>
                                </div>
                                        ...
                                        {backgroundType === 'image' && (
                                            <div className='space-y-3'>
                                                ...
                                                <div>
                                                    ...
                                                    />
                                                    <Button onClick={handleSaveUrl} className='mt-2 w-full'>
                ...
                <div className='border-border/50 mt-6 space-y-5 border-t pt-6'>
                    ...
                    <div>
                        <label className='text-foreground mb-2 block text-sm font-medium'>Fonts</label>
