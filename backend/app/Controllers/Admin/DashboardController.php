            ...
            if ($currentVersionResponse !== false) {
                ...
                if (
                    ...
                    $versionInfo["current"] = [
                        ...
                        "release_name" =>
                            $versionData["release_name"] ?? "Unknown Release",
                        "release_description" =>
                            $versionData["release_description"] ?? "",
                        "php_version" => $versionData["php_version"] ?? "8.2",
                        "changelog_added" =>
                            $versionData["changelog_added"] ?? [],
                        "changelog_fixed" =>
                            $versionData["changelog_fixed"] ?? [],
                        "changelog_improved" =>
                            $versionData["changelog_improved"] ?? [],
                        "changelog_updated" =>
                            $versionData["changelog_updated"] ?? [],
                        "changelog_removed" =>
                            $versionData["changelog_removed"] ?? [],
                    ];
            ...
            if ($latestVersionResponse !== false) {
                ...
                if (
                    ...
                    $versionInfo["latest"] = [
                        ...
                        "release_description" =>
                            $latestData["release_description"] ?? "",
                        "changelog_added" =>
                            $latestData["changelog_added"] ?? [],
                        "changelog_fixed" =>
                            $latestData["changelog_fixed"] ?? [],
                        "changelog_improved" =>
                            $latestData["changelog_improved"] ?? [],
                        "changelog_updated" =>
                            $latestData["changelog_updated"] ?? [],
                        "changelog_removed" =>
                            $latestData["changelog_removed"] ?? [],
                    ];
