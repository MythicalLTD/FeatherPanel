...
/**
 * LDAP provider model for CRUD operations on the featherpanel_ldap_providers table.
 */
class LdapProvider
{
    private static string $table = 'featherpanel_ldap_providers';
    ...
    {
        $required = ['uuid', 'name', 'host', 'base_dn'];
