...
class ExportPermissions extends App implements CommandBuilder
{
    ...
    private static function generatePHPFile(array $permissionNodes, array $permissionMetadata): string
    {
        $phpContent = "<?php\n\n";
        $phpContent .= "/*\n";
        $phpContent .= " * This file is part of App.\n";
        ...
        $phpContent .= " * Use 'php App permissionExport' to regenerate this file\n";
        $phpContent .= " * Manual modifications will be overwritten on next generation.\n";
        $phpContent .= " */\n\n";

        $phpContent .= "namespace App;\n\n";
    ...
    private static function generateTypeScriptFile(array $permissionNodes, array $permissionMetadata): string
    {
        ...
        $tsContent .= " * Use 'php App permissionExport' to regenerate this file\n";
    ...
    {
        $readme = "# App Permission Nodes\n\n";
        $readme .= "This document provides a comprehensive overview of all permission nodes used in App.\n\n";
        $readme .= "## Overview\n\n";
        ...
        $readme .= "```typescript\n";
        $readme .= "import Permissions from '@/App/Permissions';\n\n";
        $readme .= "// Check if user has permission\n";
        $readme .= "if (auth.user.hasPermission(Permissions.ADMIN_DASHBOARD_VIEW)) {\n";
        $readme .= "    // User can view dashboard\n";
        $readme .= "}\n";
        ...
        $readme .= "3. Run `php App permissionExport` to regenerate all files\n";
        ...
        $readme .= "- **TypeScript:** `frontend/src/App/Permissions.ts`\n";
