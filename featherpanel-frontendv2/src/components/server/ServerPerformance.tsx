          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-xs">
                <span className="text-muted-foreground">{t('servers.console.info_cards.limit', { limit: chart.limit })}</span>
                <span
                    ...
                    <LineChart data={chart.data}>
                      ...
                      <Tooltip
                        content={({ active, payload }) => {
                          ...
                          } else if (chart.title === t('servers.console.performance.network')) {
