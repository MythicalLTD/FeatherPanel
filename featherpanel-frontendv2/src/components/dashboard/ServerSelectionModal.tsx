                        ...
                        servers.map(server => (
                            ...
                            >
                                <div className="flex items-center gap-3 min-w-0">
                                    <div className={`p-2 rounded-lg ${Number(selectedServerId) === server.id ? 'bg-primary/20 text-primary' : 'bg-muted text-muted-foreground group-hover:bg-muted/80'}`}>
                                        <ServerIcon className="h-4 w-4" />
                                    </div>
                                    <div className="min-w-0">
                                        <p className={`text-sm font-medium truncate ${Number(selectedServerId) === server.id ? 'text-primary' : 'text-foreground'}`}>
                                            {server.name}
                                        </p>
