							...
							<DialogPanel className="w-full max-w-md transform overflow-hidden rounded-3xl bg-card border border-border shadow-2xl transition-all">
								<div className="p-8">
									...
									<div className="space-y-4">
										<div>
											<label className="block text-sm font-medium mb-2">{t('servers.folderName')}</label>
											<input
												type="text"
												value={formData.name}
										...
										<div>
											<label className="block text-sm font-medium mb-2">{t('servers.folderDescription')}</label>
											<textarea
