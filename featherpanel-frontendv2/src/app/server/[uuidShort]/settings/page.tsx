        ...
        <div key={pathname} className="max-w-6xl mx-auto space-y-8 pb-16 font-sans">
                    ...
                    >
                        <div className="space-y-4">
                            <div className="space-y-2">
                             ...
                             <div className="space-y-2">
                                <Label className="text-xs font-bold uppercase tracking-wider text-muted-foreground ml-1">{t('serverSettings.serverDescription')}</Label>
                                <Input 
                                    value={description}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                             ...
                             <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2 p-1 pl-4 pr-1 bg-white/5 border border-white/5 rounded-xl hover:border-blue-500/30 transition-colors group/input">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => copyToClipboard(server?.sftp?.host ? `sftp://${server.sftp.host}` : '')}
                                    >
                         ...
                         <div className="mt-6 p-4 bg-blue-500/5 border border-blue-500/10 rounded-2xl">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="space-y-2">
                                     <h4 className="text-sm font-bold text-blue-500 uppercase tracking-wide">{t('serverSettings.sftpInfoTitle')}</h4>
                                     <p className="text-xs text-muted-foreground leading-relaxed">{t('serverSettings.sftpInfoDescription')}</p>
                                </div>
                            </div>
                         </div>
                    </PageCard>
            ...
            <Dialog open={showReinstallDialog} onOpenChange={setShowReinstallDialog}>
                <DialogContent>
                    <DialogHeader>
                     ...
                     <div className="space-y-4 py-4">
                        <div className="space-y-2">
                            ...
                            />
                            <p className="text-xs text-muted-foreground">{t('serverSettings.typeReinstallToConfirm')}</p>
                        </div>
                    ...
                    <DialogFooter>
                        <Button variant="ghost" onClick={() => setShowReinstallDialog(false)}>{t('common.cancel')}</Button>
                        <Button 
                            variant="destructive" 
            ...
            <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
               <DialogContent className="sm:max-w-md">
                   ...
                   <div className="py-4">
                       ...
                       {deleteStep === 2 && (
                           <div className="space-y-4">
                               <p className="text-sm text-muted-foreground">{t('serverSettings.deleteServerStep2Description')}</p>
                       ...
                       {deleteStep === 3 && (
                           <div className="space-y-4">
                               <p className="text-sm text-muted-foreground">{t('serverSettings.deleteServerStep3Description')}</p>
                               <div className="space-y-2">
                                   <Label>{t('serverSettings.deleteServerStep3Question', { num1: String(mathQuestion.num1), num2: String(mathQuestion.num2) })}</Label>
                                   <Input
                                       type="number"
                                       value={mathAnswer}
                        ...
                        {deleteStep === 4 && (
                           <div className="space-y-4">
                               <p className="text-sm text-muted-foreground">{t('serverSettings.deleteServerStep4Description')}</p>
                               <div className="space-y-2">
                                   <p className="text-xs font-mono p-2 bg-white/5 rounded border border-white/10">{server?.name}</p>
                                   <Input
                   ...
                   <DialogFooter className="gap-2 sm:gap-0">
                       <Button variant="ghost" onClick={() => setShowDeleteDialog(false)}>{t('common.cancel')}</Button>
                       <div className="flex-1" />
                       {deleteStep > 1 && (
                           <Button variant="outline" onClick={() => setDeleteStep(prev => prev - 1)}>{t('serverSettings.deleteServerBack')}</Button>
                       )}
                       {deleteStep < 4 ? (
                           <Button 
                                onClick={() => setDeleteStep(prev => prev + 1)}
                                disabled={
                                    (deleteStep === 2 && !confirmIrreversible) ||
                                    (deleteStep === 3 && !isMathCorrect)
                                }
                            >
