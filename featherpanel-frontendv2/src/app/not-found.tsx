          ...
          <div className="relative rounded-3xl border border-border/50 bg-card/95 backdrop-blur-xl p-8 md:p-12 shadow-2xl shadow-black/20">
            <div className="text-center space-y-6">
              ...
              <div className="relative">
                <h1 className="text-9xl md:text-[12rem] font-black bg-gradient-to-br from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent leading-none">
                  404
                </h1>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-6xl md:text-7xl opacity-10">
                    🔍
                  </div>
                </div>
              </div>
