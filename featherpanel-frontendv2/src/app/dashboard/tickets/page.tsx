        ...
        <div className="space-y-6">
            ...
            {loading ? (
                ...
                <div className="text-center py-24 rounded-xl border border-dashed border-border/50 bg-card/10">
                    ...
                    <Link href="/dashboard/tickets/create">
                        <Button variant="default" className="bg-primary hover:bg-primary/90 text-primary-foreground text-base px-6 py-6 h-auto shadow-lg shadow-primary/20">
                                        ...
                                        <div className="flex gap-2">
                                            {ticket.status && (
                                                <Badge 
                                                    ...
                                                    style={{ 
                                                        backgroundColor: ticket.status.color ? `${ticket.status.color}20` : 'hsl(var(--primary) / 0.1)',
                                            ...
                                            {ticket.priority && (
                                                <Badge variant="secondary" className="bg-secondary/50 text-secondary-foreground/80 border-0 rounded-md">
